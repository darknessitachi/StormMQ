...
public class MapedFileQueue {
    ...
    public MapedFileQueue(final String storePath,int mapedFileSize,AllocateMappedFileService allocateMappedFileService){
        this.storePath = storePath;
        this.mapedFileSize = mapedFileSize;
        this.allocateMappedFileService = allocateMappedFileService;
    }
    public MapedFile getMapedFileByTime(final long timstamp){
        ...
        for(int i = 0;i < mfs.length; ++i){
            ...
            if(mapedFile.getLastModifiedTimestamp()>=storeTimestamp){
                return  mapedFile;
            }
        }
    ...
    private Object[] copyMapedFiles(final int reservedMapedFiles){
        ...
        try {
            ...
            if(this.mapedFileSize <= reservedMapedFiles){
                return  null;
            }
        ...
        for(MapedFile file: this.mapedFiles){
            ...
            if (fileTailOffset > offset) {
                if (offset >= file.getFileFromOffset()) {
                    ...
                    file.setCommittedPostion((int) (offset % this.mapedFileSize));
                }
                else {
                    // 将文件删除掉
                    file.destroy(1000);
        ...
        if(files != null){
            ...
            for(File file : files){
                ...
                try{
                    ...
                    mapedFile.setCommittedPostion(this.mapedFileSize);
    ...
    public MapedFile getLastMapedFile(final long startOffset){
        ...
        if(createOffset != -1){
            ...
            if(this.allocateMappedFileService != null){
                mapedFile = this.allocateMappedFileService.putRequestAndReturnMapedFile(nextFilePath,nextNextFilePath,this.mapedFileSize);
            }else{
                try {
