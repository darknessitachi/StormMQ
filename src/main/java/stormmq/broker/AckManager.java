...
public class AckManager {
	...
	private static ConcurrentLinkedQueue<SendResult> ackQueue = new ConcurrentLinkedQueue<>();
	private static ConcurrentHashMap<String/* requestId */, Channel> producerMap = new ConcurrentHashMap<>();
